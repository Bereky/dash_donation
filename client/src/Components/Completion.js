...
const Completion = () => {
    ...
    return ( 
        <div className="h-auto min-h-56 mt-16 mb-5 flex justify-center items-center flex-col space-y-3">
            <div className="w-100 h-16 " data-aos="zoom-in-down" data-aos-duration="1000">
                <h1 className="text-4xl text-orangeMain font-bold">Thank you!</h1>
            </div>
            <div className="w-100 h-auto flex justify-center items-center my-10" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div className="w-100 h-auto ">
                <div className="h-12 w-100 flex items-center justify-center" data-aos="fade-left" data-aos-duration="1500">
